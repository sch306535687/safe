...
import sun.ch.safe.SoftWareManagerActivity;
...
public class UnlockFragment extends Fragment {
    ...
    private List<Info> unlockList;
    private TextView unlock_count;
    private MyLockAdapter adapter;

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_unlock, null);
        listview = (ListView) view.findViewById(R.id.listview);
        unlock_count = (TextView) view.findViewById(R.id.unlock_count);
    ...
    private class MyLockAdapter extends BaseAdapter{
        ...
        @Override
        public int getCount() {
            unlock_count.setText("未加锁软件("+unlockList.size()+")个");
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final Info info = unlockList.get(position);
                    ...
                    new Thread(){
                        ...
                        public void run() {
                            ...
                            getActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    boolean b = dao.add(info.getPackAgeName());//添加到加锁数据库
                                    if(b){
